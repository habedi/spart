...
- Public API docs are generated by `rustdoc` from the module docs and item docs in `src/`. Every module carries a runnable example in its module-level
  docs, and almost every public item carries a doc comment; document any item you add.
